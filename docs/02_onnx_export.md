...
```text
models/yolo26n_sanoscience_full_left/0_baseline_pytorch/best.pt   (FP32 baseline, read only)
        │
...
```text
models/yolo26n_sanoscience_full_left/0_baseline_pytorch/best.onnx                   (9.4 MB, FP32, opset 17)
models/yolo26n_sanoscience_full_left/0_baseline_pytorch/best.onnx.provenance.json   (sha256 + versions + parity record)
```
