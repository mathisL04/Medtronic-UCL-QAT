...
pipeline (`docs/00`–`docs/08`, `results/models/`, `scripts/`) stays exactly as it is. This folder holds
...
| `profiling_exports/` | Per-kernel and per-region profiles behind `results/notebooks/qat_vs_ptq_kernel_profiling.ipynb`. |
