...
OUTROOT = REPO / "results/experiments/qat_iteration_2/engine_verification"
...
ENGINES = [
    ("FP32",          "results/models/yolo26n_sanoscience_full_left/1_fp32/best_fp32.engine"),
    ("FP16",          "results/models/yolo26n_sanoscience_full_left/2_fp16/best_fp16.engine"),
    ("V4_int8_ptq",   "results/models/yolo26n_sanoscience_full_left/3_int8_ptq/best_int8.engine"),
    ("PTQ_int8_fp16", "results/experiments/qat_iteration_2/ptq_baseline/best_int8_fp16.engine"),
    ("PTQ_maxfp16",   "results/experiments/qat_iteration_2/ptq_baseline/best_int8_fp16_max.engine"),
    ("V6_qat",        "results/models/yolo26n_sanoscience_full_left/4_qat_iteration1/best_qat_int8.engine"),
]
