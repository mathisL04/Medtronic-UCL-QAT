...
```text
experiments/qat_iteration_2/sweeps/V2_batch_32/           the training run
...
experiments/qat_iteration_2/rebuild_fp16_opt5/            the rebuild that made it fast
...
FP16=1 OPT_LEVEL=5 DEVICE=<idle gpu> \
  ONNX_PATH=experiments/qat_iteration_2/sweeps/V2_batch_32/best_qat.onnx \
